                        ...
                        match nav {
                            ...
                            MenuNav::Accept => match state.nav_accept(rom_present.check()) {
                                ...
                                NavResult::OpenUsernameEntry => {
                                    // Use the player's existing name everywhere — no
                                    // re-prompt. The name is the same identity used in
                                    // lobby chat (set in Settings, or an autogenerated
                                    // default), so finding/creating a match never asks
                                    // for a name again. Players rename via Settings.
